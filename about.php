...
<div class="heading" style="background:url(images/buyshop.jpg) no-repeat">
   <h1>about us</h1>
</div>
...
<section class="about">
   ...
   <div class="image">
      <img src="images/aboutshop.jpg" alt="">
   </div>
